    ...
    return (
        <div className="visit-container">
            <div className="mt-4 visit-card">
                ...
                <h2 className="text-center pt-4">Select Tour Countries</h2>
                <div className="d-flex flex-column align-items-center">
                    ...
                    <h5 className="modal-title text-center" id="exampleModalLabel">{getRandomCountry ? "Congratulations! Have A Safe Journey!" : "Sorry! But You Have Not Chosen Any Countries"}</h5>
                ...
                <div className="d-flex flex-column align-items-center btn-div ms-5">
                    ...
                    className="btn btn-dark px-5 py-2 mb-4 pt-3 pb-3" 
                    type="button" 
                    data-bs-toggle="modal" 
                    data-bs-target="#exampleModal"
                    data-bs-backdrop="false"
                    >
                        Choose one for me <i className="fa-solid fa-earth-americas ms-2 "></i> 
                    </button>

                    <button onClick={clearList} className="btn btn-secondary py-2 px-5 pt-3 pb-3" >Choose Again <i className="fa-solid fa-clipboard-list ms-2"></i></button>
                </div>
